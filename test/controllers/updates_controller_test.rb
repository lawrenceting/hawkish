...
class UpdatesControllerTest < ActionController::TestCase
  ...
  test "should create update" do
    assert_difference('Update.count') do
      post :create, update: { content: @update.content, date: @update.date, tracker_id: @update.tracker_id }
    end
  ...
  test "should update update" do
    patch :update, id: @update, update: { content: @update.content, date: @update.date, tracker_id: @update.tracker_id }
    assert_redirected_to update_path(assigns(:update))
  end
